...
import { CashPaymentRegisterInvoiceAndRecordTaxItemRead } from "@/components/cash-payment-register-invoice-and-record-tax-item-read";
import {
  ChartOfAccountsType,
...
export const CashPaymentRegisterInvoiceAndRecordTaxRead: React.FC<{
          ...
          <table className="w-full text-sm text-left rtl:text-right">
            ...
            <tbody>
              {itemsOfAccounting.map((item, index: number) => (
                <CashPaymentRegisterInvoiceAndRecordTaxItemRead
                  key={item.id}
                  index={index}
