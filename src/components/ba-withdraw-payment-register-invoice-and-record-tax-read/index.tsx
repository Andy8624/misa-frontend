...
import { BAWithdrawPaymentRegisterInvoiceAndRecordTaxItemRead } from "@/components/ba-withdraw-payment-register-invoice-and-record-tax-item-read";
...
export const BAWithdrawPaymentRegisterInvoiceAndRecordTaxRead: React.FC<{
          ...
          <table className="w-full text-sm text-left rtl:text-right">
            ...
            <tbody>
              {itemsOfAccounting.map((item, index: number) => (
                <BAWithdrawPaymentRegisterInvoiceAndRecordTaxItemRead
                  key={item.id}
                  index={index}
