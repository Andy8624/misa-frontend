...
export const InventoryIn: React.FC = () => {
        ...
        setList(
          responseList.data.data.map((item: any) => {
            ...
            responseItems.data.data.forEach((itemOfResItems: any) => {
              if (itemOfResItems?.inventory_in === item.id) {
                totalAmount +=
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="p-3 text-left">Ngày hạch toán</th>
              <th className="p-3 text-left">Số chứng từ</th>
              <th className="p-3 text-left">Diễn giải</th>
              <th className="p-3 text-right">Tổng tiền</th>
              <th className="p-3 text-left">Người giao/người nhận</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
