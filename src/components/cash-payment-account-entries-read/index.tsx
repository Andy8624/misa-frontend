...
import { CashPaymentAccountEntriesItemRead } from "@/components/cash-payment-account-entries-item-read";
import { useEffect } from "react";

export const CashPaymentAccountEntriesRead: React.FC<{
          ...
          <table className="w-full text-sm text-left rtl:text-right">
            ...
            <tbody>
              {itemsOfAccounting.map((item, index: number) => (
                <CashPaymentAccountEntriesItemRead
                  key={item.id}
                  index={index}
