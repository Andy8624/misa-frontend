...
export const SalesVoucherInventoryOutVoucherRead: React.FC<{
  ...
  salesVoucher
    ...
    useEffect(() => {
      if (salesVoucher?.id) {
        setStorePerson(salesVoucher?.inventory_out_voucher_storeperson || undefined);
        setReceipient(salesVoucher?.inventory_out_voucher_receipient || undefined);
        setParticular(salesVoucher?.inventory_out_voucher_particular || undefined);
        setWithOriginalVoucher(salesVoucher?.inventory_out_voucher_with_original_voucher || undefined)
      }
    }, [salesVoucher])
