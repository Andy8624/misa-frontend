...
export const BAWithdrawPaymentRegisterInvoiceAndRecordTaxItemRead: React.FC<{
  index: number;
  item: any;
  ...
  listGroupOfPurchasedGoods,
    ...
    const [invoiceDate, setInvoiceDate] = useState<string | undefined>(item?.invoice_date || undefined);
