...
import { InventoryOutQuantityValue } from "@/components/inventory-out-quantity-value";
...
export default function InventoryOut() {
  ...
  const [receipientOfProduction, setReceipientOfProduction] = useState<string | undefined>();
  ...
  const handleSave = async () => {
    const data: any = {};
    data.inventory_out_voucher_type = inventoryOutVoucherType;
    data.inventory_out
    ...
    if (
      inventoryOutVoucherType === OPTION_INVENTORY_OUT_VOUCHER_TYPE.PRODUCTION.value
    ) {
