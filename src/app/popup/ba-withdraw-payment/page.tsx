...
import { BAWithdrawPaymentAccountEntries } from "@/components/ba-withdraw-payment-account-entries";
...
export default function BAWithdraw() {
  ...
  const [backTo, setBackTo] = useState<string>(
    `/ba-deposit?tab=${OPTION_TAB_CASH.CASH_PAYMENT}`
  );
              ...
              items={[
                {
                  ...
                  active: true,
                  children: (
                    <BAWithdrawPaymentAccountEntries
                ...
                },
                {
                  ...
                  active:
                    paymentType ===
                      ...
                      : false,
                  children: (
                    <BAWithdrawPaymentRegisterInvoiceAndRecordTax
                      itemsOfAccounting={itemsOfAccounting}
                      handleChangeItemsOfAccounting={
                        handleChangeItemsOfAccounting
                      }
